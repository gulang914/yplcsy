...
class CreateVitalFeatureTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vital_feature', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('project_id')->comment('项目id号');
    ...
    {
        Schema::dropIfExists('vital_feature');
    }
}
