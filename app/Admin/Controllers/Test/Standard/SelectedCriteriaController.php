...
use App\Model\Test\Standard\SelectedCriteria;
...
class SelectedCriteriaController extends Controller
{
    use ModelForm;
    ...
    {
        $this->tableName = (new SelectedCriteria)->getTable();
    }
    /**
     * Index interface.
     *
    ...
    {
        return Admin::grid(SelectedCriteria::class, function (Grid $grid) {
    ...
    {
        $show = new Show(SelectedCriteria::findOrFail($id));
    ...
    {
        return Admin::form(SelectedCriteria::class, function (Form $form) {
